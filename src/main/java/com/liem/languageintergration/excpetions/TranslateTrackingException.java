...
/**
 * The type Translate tracking exception.
 */
public class TranslateTrackingException extends RuntimeException {

  /**
   * Constructs a new runtime exception with {@code null} as its detail message.  The cause is not
   * initialized, and may subsequently be initialized by a call to {@link #initCause}.
   */
  public TranslateTrackingException() {
    }
   ...
   */
  public TranslateTrackingException(String message) {
        super(message);
    }
   ...
   * @since 1.4
   */
  public TranslateTrackingException(String message, Throwable cause) {
        super(message, cause);
    }
}
